  ...
  function initializeSubServiceModal() {
    ...
    const contentMap = {
      0: {
        ...
        description: 'Focuses on the big picture of your manuscript. We work on structure, plot, character development, pacing, and overall narrative flow to ensure your story achieves its full potential.'
      },
      1: {
        title: 'Copyediting',
        description: 'Ensures your manuscript is polished and professional. We correct grammar, spelling, punctuation, and syntax while maintaining your unique voice and style throughout the text.'
      },
      2: {
        title: 'Proofreading',
        description: 'The final quality check before publication. We catch any remaining typos, formatting inconsistencies, and minor errors to ensure your book is publication-ready.'
      }
    };
  ...
  function initializeDesignModal() {
    ...
    const contentMap = {
      0: {
        ...
        description: 'Professional formatting and typesetting for print and digital formats. We ensure your manuscript meets industry standards with proper margins, fonts, spacing, and page flow for an exceptional reading experience.'
      },
      1: {
        title: 'Cover Design',
        description: 'Eye-catching cover designs that capture your book\'s essence and attract readers. Our designers create compelling covers that stand out in both physical stores and online marketplaces.'
      },
      2: {
        title: 'Illustrations & Graphics',
        description: 'Custom illustrations, charts, diagrams, and graphics that enhance your content. Perfect for children\'s books, textbooks, technical manuals, and any publication requiring visual elements.'
      }
    };
  ...
  function initializeDesignModal() {
    ...
    const contentMap = {
      0: {
        ...
        description: 'Obtain a unique ISBN for your book, essential for distribution and sales tracking.'
      },
      1: {
        title: 'Printing',
        description: 'High-quality printing services for your book, ensuring vibrant colors and crisp text. We offer various printing options, including paperback, hardcover, and digital formats.'
      },
      2: {
        title: 'E-book Conversion',
        description: 'Transform your manuscript into a professional e-book format, compatible with all major e-readers and devices.'
      },
      3: {
        title: 'Distribution',
        description: 'Comprehensive distribution services to get your book into the hands of readers worldwide. We handle everything from online retailers to brick-and-mortar stores.'
      }
    };
